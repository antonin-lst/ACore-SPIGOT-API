	  ...
	  private static String packageName;
	    ...
	    static {
	        ...
	        try {
	            ...
	            System.out.println("Error while loading NMS methods. (Unsupported Minecraft version?)" + e);
	        }
	    ...
	    public static void sendPacket(Object packet, Player... players) {
	        for(Player p : players) {
	            try {
	                ...
	                System.out.println("Error while sending packet to player. (Unsupported Minecraft version?)" + e);
	            }
	        }
	    }
