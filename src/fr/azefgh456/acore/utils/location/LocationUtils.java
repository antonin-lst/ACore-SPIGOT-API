package fr.azefgh456.acore.utils.location;
...
public class LocationUtils {
	...
	public static Location deserealizeLocation(String loc){
		if(loc == null || loc.isEmpty() || loc.equalsIgnoreCase("null")) return null;
	...
	public static Map<String, Location> deserealizeLocations(String locs){
		...
		if(locs == null || locs.equalsIgnoreCase("null")) return new HashMap<>();
